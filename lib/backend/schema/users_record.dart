...
class UsersRecord extends FirestoreRecord {
  ...
  // "personalProjects" field.
  List<EcStruct>? _personalProjects;
  List<EcStruct> get personalProjects => _personalProjects ?? const [];
  bool hasPersonalProjects() => _personalProjects != null;
  ...
  void _initializeFields() {
    ...
    _personalProjects = getStructList(
      snapshotData['personalProjects'],
      EcStruct.fromMap,
    );
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        listEquality.equals(e1?.personalProjects, e2?.personalProjects);
  }
